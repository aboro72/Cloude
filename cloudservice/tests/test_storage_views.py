...
class StorageViewsTest(TestCase):
    ...
    def test_create_group_creates_team_site_library_and_redirects_to_detail(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertEqual(response['Location'], reverse('sharing:group_detail', kwargs={'group_id': group.id}))
    ...
    def test_group_detail_page_renders(self):
        ...
        response = self.client.get(reverse('sharing:group_detail', kwargs={'group_id': group.id}))
    ...
    def test_team_leader_can_create_team_news(self):
        ...
        response = self.client.post(
            reverse('sharing:team_news_create', kwargs={'group_id': group.id}),
            {
                'title': 'Sprint Update',
                'summary': 'Kurzstatus',
    ...
    def test_profile_page_shows_account_overview_sections(self):
        ...
        self.user.profile.save(update_fields=['bio', 'color_preset', 'design_variant'])
